...
def init_db():
    if db.pg:
        ...
        'CREATE TABLE IF NOT EXISTS daily_attendance (id SERIAL PRIMARY KEY, worker_id INTEGER NOT NULL, month_year TEXT NOT NULL, day INTEGER NOT NULL, status TEXT NOT NULL DEFAULT \'P\', UNIQUE(worker_id,month_year,day))']
    else:
        stmts=[
        ...
        'CREATE TABLE IF NOT EXISTS daily_attendance (id INTEGER PRIMARY KEY AUTOINCREMENT, worker_id INTEGER NOT NULL, month_year TEXT NOT NULL, day INTEGER NOT NULL, status TEXT NOT NULL DEFAULT \'P\', UNIQUE(worker_id,month_year,day))']
